          ...
          <ChevronLeft className ='text-gray-500 h-6 w-6 sm:h-8 sm:w-8 border-2 rounded-full p-1' />
            ...
            <div>
                ...
                <p className ='text-base sm:text-lg lg:text-xl text-gray-400 mb-6 sm:mb-8'>
                    {isSignUp
                    ? 'Join NifferStore today and discover deals and favorite Products!' : 'Welcome to NifferStore! Log in to continue your shopping today.'}
                </p> 
             </div>
             {/* Toggle form*/}
             <div className = 'mt-4 sm:mt-5 flex item-center justify-center'>
             ...
             <button
             variant = 'link'
             className = 'text-lg sm:text-xl lg:text-2xl text-gray-500 cursor-pointer' onClick={toggleForm}
             >
